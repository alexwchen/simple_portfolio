(function(){
  ...
  .factory('expService',['$state', '$rootScope', function($state, $rootScope){
    ...
    var affData = [
      {
        title:"Top 25% certificate, Euclid Mathematics Contest, University of Waterloo",
        time:"2007&2008"
      },
      {
        title:"Top 25% certificate, Sun Life Financial Canadian Open Mathematics Challenge",
        time:"2007&2008"
      },
      {
        title:"University of Toronto Entrance Scholarship, University of Toronto",
        time:"2008"
      },
      {
        title:"Canada Millennium Scholarship, Ontario Student Assistance Program",
        time:"2008"
      }
    ];
